...
from events.forms import InvitationForm, EventToInvitationForm

urlpatterns = patterns('events.views',
    url(r'^$', 'events', name="event_list_all"),
    url(r'^(?P<year>\d+)/(?P<month>\d+)$', 'events_month', name='events_month'),
...
#         'event_type':1,
#         'template_name':'events/event_to_invitation.html'},
...
#        kwargs={'form_class': InvitationForm, 'template_name': 'events/new_invitation.html', 'event_type': 1}, 
#        name='invitation_new'),
